...
import { ResponseArticleGoodsIssueNoteEntryDto } from 'src/modules/goods-issue-note/dtos/article-goods-issue-note-entry.response.dto';
...
import { ResponseGoodsIssueNoteMetaDataDto } from './goods-issue-note-meta-data.response.dto';
...
import { ResponseGoodsIssueNoteUploadDto } from './goods-issue-note-upload.response.dto';

export class ResponseGoodsIssueNoteDto {
  ...
  @ApiProperty({
    type: () => ResponseArticleGoodsIssueNoteEntryDto,
    isArray: true,
  })
  articleGoodsIssueNoteEntries?: ResponseArticleGoodsIssueNoteEntryDto[];

  @ApiProperty({ type: () => ResponseGoodsIssueNoteMetaDataDto })
  goodsIssueNoteMetaData?: ResponseGoodsIssueNoteMetaDataDto;

  @ApiProperty({ required: false })
  uploads?: ResponseGoodsIssueNoteUploadDto[];
