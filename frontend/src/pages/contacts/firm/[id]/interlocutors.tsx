...
import { InterlocutorEmbeddedPortal } from '@/components/contacts/interlocutor/InterlocutorEmbeddedPortal';
...
export default function Page() {
  ...
  return (
    <FirmDetails firmId={id}>
      <InterlocutorEmbeddedPortal firmId={parseInt(id)} routes={routes} />
    </FirmDetails>
  );
}
