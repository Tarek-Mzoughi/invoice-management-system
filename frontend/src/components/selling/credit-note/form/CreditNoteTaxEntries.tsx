...
import { ArticleCreditNoteEntry, Currency, Tax } from '@/types';
...
interface CreditNoteTaxEntriesProps {
  className?: string;
...
export const CreditNoteTaxEntries: React.FC<CreditNoteTaxEntriesProps> = ({
  className,
  article,
  taxes,
  selectedTaxIds,
  ...
  return (
    <div className={cn('flex flex-col', className)}>
      ...
      {article.articleCreditNoteEntryTaxes?.map((appliedTax, i) => (
