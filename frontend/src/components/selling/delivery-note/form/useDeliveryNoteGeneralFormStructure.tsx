...
export const useDeliveryNoteGeneralFormStructure = ({
  ...
  const documentLabels = useScopedDocumentLabels('deliveryNote', 'selling');
  const firmLabel = tInvoicing('deliveryNote.attributes.customer');
  const firmPlaceholder = tInvoicing('deliveryNote.associate_customer');
