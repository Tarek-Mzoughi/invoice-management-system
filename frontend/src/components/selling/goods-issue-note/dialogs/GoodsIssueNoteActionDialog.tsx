...
interface GoodsIssueNoteActionDialogProps {
  className?: string;
  id?: number;
  action?: string;
  sequential: string;
...
export const GoodsIssueNoteActionDialog: React.FC<GoodsIssueNoteActionDialogProps> = ({
  className,
  id,
  action,
  sequential,
  ...
  const header = (
    <Label className="leading-5">
      Voulez-vous vraiment {action?.toLowerCase()} le Bon de sortie N°{' '}
