...
interface GoodsIssueNoteBulkDeleteDialogProps {
  className?: string;
  count: number;
  open: boolean;
  onDelete: () => void;
...
export const GoodsIssueNoteBulkDeleteDialog: React.FC<GoodsIssueNoteBulkDeleteDialogProps> = ({
  className,
  count,
  open,
  onDelete,
  ...
  const header = (
    <Label className="leading-5">
      <Trans
        i18nKey="goodsIssueNote.bulk_remove_confirmation"
        t={tInvoicing}
        values={{ count }}
