...
import { ArticleGoodsIssueNoteEntry, Currency, Tax } from '@/types';
...
interface GoodsIssueNoteTaxEntriesProps {
  className?: string;
...
export const GoodsIssueNoteTaxEntries: React.FC<GoodsIssueNoteTaxEntriesProps> = ({
  className,
  article,
  taxes,
  selectedTaxIds,
  ...
  return (
    <div className={cn('flex flex-col', className)}>
      ...
      {article.articleGoodsIssueNoteEntryTaxes?.map((appliedTax, i) => (
