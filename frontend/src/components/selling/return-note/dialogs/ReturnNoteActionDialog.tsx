...
interface ReturnNoteActionDialogProps {
  className?: string;
  id?: number;
  action?: string;
  sequential: string;
...
export const ReturnNoteActionDialog: React.FC<ReturnNoteActionDialogProps> = ({
  className,
  id,
  action,
  sequential,
  ...
  const header = (
    <Label className="leading-5">
      Voulez-vous vraiment {action?.toLowerCase()} le Bon de Retour N°{' '}
