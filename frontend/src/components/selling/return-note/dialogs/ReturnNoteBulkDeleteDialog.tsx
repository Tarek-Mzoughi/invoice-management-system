...
interface ReturnNoteBulkDeleteDialogProps {
  className?: string;
  count: number;
  open: boolean;
  onDelete: () => void;
...
export const ReturnNoteBulkDeleteDialog: React.FC<ReturnNoteBulkDeleteDialogProps> = ({
  className,
  count,
  open,
  onDelete,
  ...
  const header = (
    <Label className="leading-5">
      <Trans
        i18nKey="returnNote.bulk_remove_confirmation"
        t={tInvoicing}
        values={{ count }}
