...
export const useReturnNoteGeneralFormStructure = ({
  ...
  const documentLabels = useScopedDocumentLabels('returnNote', 'selling');
  const firmLabel = tInvoicing('returnNote.attributes.customer');
  const firmPlaceholder = tInvoicing('returnNote.associate_customer');
