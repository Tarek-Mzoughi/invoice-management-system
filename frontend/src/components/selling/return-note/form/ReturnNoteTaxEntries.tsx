...
import { ArticleReturnNoteEntry, Currency, Tax } from '@/types';
...
interface ReturnNoteTaxEntriesProps {
  className?: string;
...
export const ReturnNoteTaxEntries: React.FC<ReturnNoteTaxEntriesProps> = ({
  className,
  article,
  taxes,
  selectedTaxIds,
  ...
  return (
    <div className={cn('flex flex-col', className)}>
      ...
      {article.articleReturnNoteEntryTaxes?.map((appliedTax, i) => (
            ...
            >
              ...
              <SelectContent align="center">
                ...
                {fixedAmountTaxes.length != 0 && (
                  <SelectGroup>
                    <SelectLabel>
                      {tInvoicing('articlinterlocutorFielde.attributes.fixed_price')}
                    </SelectLabel>
