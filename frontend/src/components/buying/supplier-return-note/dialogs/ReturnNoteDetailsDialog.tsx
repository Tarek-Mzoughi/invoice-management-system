...
export const ReturnNoteDetailsDialog: React.FC<ReturnNoteDetailsDialogProps> = ({
  open,
  onClose,
  returnNote,
          ...
          <div className="flex items-center gap-2">
            <DropdownMenu modal={false} open={isActionsOpen} onOpenChange={setIsActionsOpen}>
              ...
              <DropdownMenuContent align="end" sideOffset={8} className="z-[70] w-64 p-1">
                ...
                {isSelling && !linkedInvoice && onInvoice && (
                  <DropdownMenuItem
                    onSelect={(event) => {
                      event.preventDefault();
                ...
                {isSelling && linkedInvoice?.id && onLinkedDocumentOpen && (
                  <DropdownMenuItem
                    onSelect={(event) => {
                      event.preventDefault();
          ...
          <div className="space-y-4">
            ...
            <div className="pt-2">
              <button
                type="button"
                onClick={() =>
                  returnNote.firmId && router.push(`/contacts/firm/${returnNote.firmId}`)
                }
            ...
            <div className="rounded-md border border-zinc-100 dark:border-zinc-900 overflow-hidden">
              <table className="w-full text-sm text-left">
                ...
                <tbody className="divide-y divide-zinc-100 dark:divide-zinc-900">
                  {returnNote.invoices?.map((invoice) => (
                    <tr
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-right">
                        <Button
                          ...
                          onClick={() =>
                            invoice.id && onLinkedDocumentOpen?.('invoice', invoice.id)
                          }
                          disabled={!invoice.id || !onLinkedDocumentOpen}
                        >
