...
export interface CreditNoteExportLabels {
  reference: string;
  client: string;
  status: string;
  amount: string;
...
interface CreditNoteExportOptions {
  rows: CreditNoteExportRow[];
  labels: CreditNoteExportLabels;
  title: string;
  generatedAt: string;
  fileName: string;
}
...
export const exportCreditNotesToPdf = async ({
  rows,
  labels,
  title,
  generatedAt,
  fileName
}: CreditNoteExportOptions) => {
...
export const exportCreditNotesToExcel = async ({
  rows,
  labels,
  title,
  generatedAt,
