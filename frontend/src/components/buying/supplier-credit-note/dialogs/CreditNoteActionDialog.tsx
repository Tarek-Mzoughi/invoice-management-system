...
interface CreditNoteActionDialogProps {
  className?: string;
  id?: number;
  action?: string;
  sequential: string;
...
export const CreditNoteActionDialog: React.FC<CreditNoteActionDialogProps> = ({
  className,
  id,
  action,
  sequential,
  ...
  const header = (
    <Label className="leading-5">
      Voulez-vous vraiment {action?.toLowerCase()} la facture N°{' '}
