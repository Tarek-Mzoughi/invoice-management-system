...
export const InvoiceExtraOptions = ({
  className,
  loading,
  mode = 'all'
}: InvoiceExtraOptionsProps) => {
  ...
  const notesContent = (
    <Textarea
      placeholder={tInvoice('attributes.notes')}
        ...
        >
          <AccordionTrigger className="py-4 hover:no-underline">
            <div className="flex gap-2 items-center">
              ...
              <Label>{tInvoice('attributes.files')}</Label>
            </div>
          </AccordionTrigger>
    ...
    <Accordion type="multiple" className={cn(className, 'mx-1 border-b')}>
      ...
      <AccordionItem value="item-2">
        <AccordionTrigger>
          <div className="flex gap-2 justify-center items-center">
            <NotebookTabs />
            <Label>{tInvoice('attributes.notes')}</Label>
          </div>
        </AccordionTrigger>
