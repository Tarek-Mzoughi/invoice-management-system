...
export const DeliveryNoteDetailsDialog: React.FC<DeliveryNoteDetailsDialogProps> = ({
  open,
  onClose,
  deliveryNote,
              ...
              <DropdownMenuContent align="end" className="w-64 p-1">
                ...
                {linkedInvoices.map((invoice) => (
                  <DropdownMenuItem
                    ...
                    onClick={() => invoice.id && onLinkedDocumentPreview?.('invoice', invoice.id)}
                    className="gap-2 px-3 py-2 cursor-pointer"
                  >
                ...
                {visibleReturnNotes.map((returnNote) => (
                  <DropdownMenuItem
                    ...
                    onClick={() =>
                      returnNote.id && onLinkedDocumentPreview?.('return-note', returnNote.id)
                    }
                    className="gap-2 px-3 py-2 cursor-pointer"
                  >
          ...
          <div className="space-y-4">
            ...
            <div className="pt-2">
              <button
                type="button"
                onClick={() =>
                  deliveryNote.firmId && router.push(`/contacts/firm/${deliveryNote.firmId}`)
                }
            ...
            <div className="rounded-md border border-zinc-100 dark:border-zinc-900 overflow-hidden">
              <table className="w-full text-sm text-left">
                ...
                <tbody className="divide-y divide-zinc-100 dark:divide-zinc-900">
                  ...
                  {!linkedInvoices.length && !visibleReturnNotes.length && (
                    <tr>
                      <td
                        colSpan={5}
