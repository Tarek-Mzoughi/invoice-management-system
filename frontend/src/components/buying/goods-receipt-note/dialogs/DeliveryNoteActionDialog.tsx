...
interface DeliveryNoteActionDialogProps {
  className?: string;
  id?: number;
  action?: string;
  sequential: string;
...
export const DeliveryNoteActionDialog: React.FC<DeliveryNoteActionDialogProps> = ({
  className,
  id,
  action,
  sequential,
  ...
  const header = (
    <Label className="leading-5">
      Voulez-vous vraiment {action?.toLowerCase()} le {documentLabels.document.toLowerCase()} N°{' '}
